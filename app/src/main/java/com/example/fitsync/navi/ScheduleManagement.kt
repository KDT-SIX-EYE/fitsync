...
@Composable
fun ScheduleManagement(navController: NavController) {
    FinalScheduleManagementScreen(navController)
}


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun FinalScheduleManagementScreen(navController: NavController) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
